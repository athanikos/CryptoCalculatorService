from CryptoCalculatorService.calculator.CurrencyConverter import CurrencyConverter, ConversionOrder
...
from tests.helpers import mock_log, insert_exchange_record
